...
builder.Services.AddSingleton<IAuthanticationRepository, AuthanticationRepository>();
...
app.MapPost("/login",
(UserLogin user, IAuthanticationRepository service) => Login(user, service))
    .Accepts<UserLogin>("application/json")
    .Produces<string>();

IResult Login(UserLogin user, IAuthanticationRepository service)
{
